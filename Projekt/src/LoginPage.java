...
public class LoginPage extends JFrame {
    ...
    // Color variables for app palette
    ...
    LoginPage() {
        ...
        // Additional variables for styling
        ...
        // PASSWORD TEXT (next to PasswordField)
        ...
        /* PANELS STYLE:
        *  - mainPanel - responsible for wrapping other Panels
        *  - loginPanel - login text + login input
        *  - passPanel - password text + password input
        * */
        ...
        // Two methods responsible for displaying Panel and Frame
        add(mainPanel);
        ...
        loginButton.addActionListener(e -> {
           ...
           String pass = new String(passwd.getPassword());
            // NOTE: There is a placeholder, originally who will be changing that need to receive data from file
