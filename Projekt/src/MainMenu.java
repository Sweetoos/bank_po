...
public class MainMenu extends JFrame {
    ...
    /* ------------------------------------------------------------
     *  COLOR PALETTE — Application UI colors consistent with theme
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  ACCOUNT DATA — Simple demo accounts and money state
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  ROOT PANEL + CARD LAYOUT — Used for switching between views
     * ------------------------------------------------------------ */
    JPanel menuPanel = new JPanel();
    CardLayout cardLayout = new CardLayout();

    /* ------------------------------------------------------------
     *  MAIN MENU SCREEN — Panels that form the main view
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  TRANSACTION TABLE — History of account operations
     * ------------------------------------------------------------ */
    ...
    public MainMenu() {
        ...
        /* CARD LAYOUT ROOT INITIALIZATION */
        menuPanel.setLayout(cardLayout);

        /* SUBPANELS LOADED INTO CARD LAYOUT */
        ...
        /* TRANSACTION DATA PRELOADED FOR DEMO */
    ...
    private void buildMainMenuView() {
        ...
        /* ============================================================
         *  ACCOUNT PANEL — Displays currently selected bank account
         * ============================================================ */
        ...
        /* ACCOUNT INFORMATION: name + balance */
        ...
        /* CUSTOM TABLE RENDERER FOR THEME COLORS */
        ...
        /* ============================================================
         *  OPTIONS PANEL — Navigation buttons at bottom-left
         * ============================================================ */
        ...
        /* ============================================================
         *  GRIDBAG LAYOUT — Positioning of main components
         * ============================================================ */
        c.gridx = 1;
        c.gridy = 1;
        ...
        /* ------------------------------------------------------------
         *  BUTTON LOGIC — Navigation, switching views, logout
         * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  UI UTILITIES — Styling reusable UI components
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  ACCOUNT SWITCHING — Left/right arrow navigation
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  UPDATE TABLE — Reloads transactions for current account
     * ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------
     *  DATA CLASS — Simple structure for holding transactions DEMO
     * ------------------------------------------------------------ */
